...
public class DataHero {
    ...
    public static final int[][] heroData = {new int[]{250, 200, 27, 150, 1, 0, 500, 550, 1, 125, 0, 0, 9, 0}, new int[]{300, 350, 24, 157, 1, 0, 500, 650, 1, 120, 0, 0, 9, 0}, new int[]{500, 525, 21, 164, 1, 0, 500, 760, 1, 115, 0, 0, 9, 0}, new int[]{800, 725, 18, 170, 1, 0, 500, 870, 1, 110, 0, 0, 9, 0}, new int[]{1200, 950, 15, 176, 1, 0, 500, 980, 1, 105, 0, 0, 9, 0}, new int[]{250, 150, 25, 300, 1, 1, 500, 700, 1, 125, 80, 1, 0, 1}, new int[]{300, 270, 21, 340, 1, 1, 500, 800, 1, 120, 90, 1, 0, 1}, new int[]{500, 390, 17, 380, 1, 1, 500, 900, 1, 115, 100, 1, 0, 1}, new int[]{800, 540, 13, 420, 1, 1, 500, 1050, 1, 110, 115, 1, 0, 1}, new int[]{1200, 700, 9, 470, 1, 1, 500, 1200, 1, 105, 130, 1, 0, 1}, new int[]{250, 175, 30, 250, 1, 2, 500, 600, 1, 125, 50, 1, 12, 2}, new int[]{300, 305, 27, 265, 1, 2, 500, 690, 1, 120, 60, 1, 12, 2}, new int[]{500, 440, 24, 280, 1, 2, 500, 790, 1, 115, 70, 1, 12, 2}, new int[]{800, 615, 21, 295, 1, 2, 500, 890, 1, 110, 80, 1, 12, 2}, new int[]{1200, 800, 18, 310, 1, 2, 500, 1000, 1, 105, 90, 1, 12, 2}};
}
