...
public class DataUpgradeItem {
    ...
    public static final int[][] upgradeItemData = {new int[]{1, 0, 0, 1, 300, 9}, new int[]{2, 1, -5, 1, 300, 1}, new int[]{2, 1, -8, 1, 500, 1}, new int[]{2, 1, -10, 1, 800, 1}, new int[]{2, 1, -20, 1, 1200, 1}, new int[]{2, 1, 15, 1, 300, 2}, new int[]{2, 1, 25, 1, 500, 2}, new int[]{2, 1, 35, 1, 800, 2}, new int[]{2, 1, 50, 1, 1200, 2}, new int[]{2, 1, 10, 1, 300, 3}, new int[]{2, 1, 15, 1, 500, 3}, new int[]{2, 1, 20, 1, 800, 3}, new int[]{2, 1, 30, 1, 1200, 3}, new int[]{2, 1, 10, 1, 300, 4}, new int[]{2, 1, 18, 1, 500, 4}, new int[]{2, 1, 25, 1, 800, 4}, new int[]{2, 1, 40, 1, 1200, 4}, new int[]{3, 1, 50, 1, 300, 5}, new int[]{3, 1, 80, 1, 500, 5}, new int[]{3, 1, 120, 1, 800, 5}, new int[]{3, 1, 250, 1, 1200, 5}, new int[]{3, 1, 4, 1, 300, 8}, new int[]{3, 1, 8, 1, 500, 8}, new int[]{3, 1, 12, 1, 800, 8}, new int[]{3, 1, 25, 1, 1200, 8}, new int[]{4, 1, 35, 1, 2000, 10}, new int[]{4, 1, 3, 1, 3000, 11}, new int[]{4, 1, 25, 1, 2000, 12}, new int[]{4, 1, 40, 1, 2000, 13}, new int[]{5, 0, 5, 1, 2000, 14}};
