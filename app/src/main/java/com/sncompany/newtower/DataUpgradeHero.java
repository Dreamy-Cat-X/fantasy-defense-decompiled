...
public class DataUpgradeHero {
    ...
    static final String[] upgradeHeroName = {"God's Blessing", "Raging Hero", "Dashing Hero", "Infinite Sword", "Dragon Breath", "Silent Strike"};
    static final String[] upgradeHeroDescription = {"Summon Mana %d%%", "Attack Strength +%d%%", "Attack Speed +%d%%", "Special Skill Attack Strength +%d%%", "Special Skill Mana Consumption +%d%%", "Special Skill Downtime %d%%"};
