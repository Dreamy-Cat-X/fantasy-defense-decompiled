...
public final class zzbjp implements zzepq<Set<zzbxf<com.google.android.gms.ads.internal.overlay.zzp>>> {
    private final zzeqd<zzbjf> zzeui;
    private final zzeqd<Executor> zzeuj;
    private final zzeqd<JSONObject> zzfrf;

    private zzbjp(zzeqd<zzbjf> zzeqdVar, zzeqd<Executor> zzeqdVar2, zzeqd<JSONObject> zzeqdVar3) {
        this.zzeui = zzeqdVar;
        this.zzeuj = zzeqdVar2;
        this.zzfrf = zzeqdVar3;
    }

    public static zzbjp zze(zzeqd<zzbjf> zzeqdVar, zzeqd<Executor> zzeqdVar2, zzeqd<JSONObject> zzeqdVar3) {
        return new zzbjp(zzeqdVar, zzeqdVar2, zzeqdVar3);
    }
