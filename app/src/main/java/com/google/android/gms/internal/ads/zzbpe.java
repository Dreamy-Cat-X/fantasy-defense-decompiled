...
public final class zzbpe implements zzepq<zzbxf<zzbuv>> {
    private final zzeqd<Executor> zzeuj;
    private final zzeqd<zzcji> zzfwa;
    private final zzeqd<zzcom> zzfwb;

    private zzbpe(zzeqd<zzcji> zzeqdVar, zzeqd<Executor> zzeqdVar2, zzeqd<zzcom> zzeqdVar3) {
        this.zzfwa = zzeqdVar;
        this.zzeuj = zzeqdVar2;
        this.zzfwb = zzeqdVar3;
    }

    public static zzbpe zzi(zzeqd<zzcji> zzeqdVar, zzeqd<Executor> zzeqdVar2, zzeqd<zzcom> zzeqdVar3) {
        return new zzbpe(zzeqdVar, zzeqdVar2, zzeqdVar3);
    }
