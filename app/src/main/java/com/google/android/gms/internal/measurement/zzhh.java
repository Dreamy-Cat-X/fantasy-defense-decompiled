...
final class zzhh implements zzlk {
    ...
    @Override // com.google.android.gms.internal.measurement.zzlk
    public final void zza(int i, List<?> list, zzjv zzjvVar) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zza(i, list.get(i2), zzjvVar);
        }
    }

    @Override // com.google.android.gms.internal.measurement.zzlk
    public final void zzb(int i, List<?> list, zzjv zzjvVar) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zzb(i, list.get(i2), zzjvVar);
        }
    }

    @Override // com.google.android.gms.internal.measurement.zzlk
    public final <K, V> void zza(int i, zzix<K, V> zzixVar, Map<K, V> map) throws IOException {
