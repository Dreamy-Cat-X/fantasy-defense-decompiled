            ...
            if (zzd) {
                ...
                if (!zze) {
                    ...
                    if (zzf) {
                        ...
                        int i9 = i6 + 1;
                        byte zza4 = zzkt.zza(bArr, i6);
                        int i10 = i9 + 1;
                        zzky.zzb(zza2, zza4, zzkt.zza(bArr, i9), zzkt.zza(bArr, i10), cArr, i5);
                        i = i10 + 1;
                        i5 = i5 + 1 + 1;
                    }
                } else if (i6 < i3) {
        ...
        while (i4 < length) {
            ...
            if (charAt3 >= c || j4 >= j5) {
                if (charAt3 < 2048 && j4 <= j5 - 2) {
                        ...
                        if (j4 <= j5 - 4) {
                            ...
                            if (i5 != length) {
                                ...
                                if (Character.isSurrogatePair(charAt3, charAt4)) {
                                    ...
                                    long j7 = j4 + 1;
                                    zzkt.zza(bArr, j4, (byte) ((codePoint >>> 18) | GameRenderer.GAME_STAGE_CLEAR_HIGH_SCORE_COUNT));
                                    long j8 = j7 + 1;
                    ...
                    long j10 = j4 + j;
                    zzkt.zza(bArr, j4, (byte) ((charAt3 >>> '\f') | Texture2D.SCRHEIGHT_480));
                    long j11 = j10 + j;
