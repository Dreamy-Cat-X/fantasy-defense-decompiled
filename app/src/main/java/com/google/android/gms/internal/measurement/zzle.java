...
public class zzle {
    ...
    static {
        ...
        final int i3 = 8;
        zzi = new zzle(str, i3, zzlhVar, i) { // from class: com.google.android.gms.internal.measurement.zzld
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                int i4 = 8;
                int i5 = 2;
        ...
        final int i4 = 9;
        zzj = new zzle(str2, i4, zzlhVar2, i2) { // from class: com.google.android.gms.internal.measurement.zzlg
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                int i5 = 9;
                int i6 = 3;
        ...
        final int i5 = 10;
        zzk = new zzle(str3, i5, zzlhVar3, i) { // from class: com.google.android.gms.internal.measurement.zzlf
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                int i6 = 10;
                int i7 = 2;
        ...
        final int i6 = 11;
        zzl = new zzle(str4, i6, zzlhVar4, i) { // from class: com.google.android.gms.internal.measurement.zzli
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                int i7 = 11;
                int i8 = 2;
