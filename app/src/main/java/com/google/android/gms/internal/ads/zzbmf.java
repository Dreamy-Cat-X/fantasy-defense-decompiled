...
public final class zzbmf implements zzepq<zzcqq<zzblb>> {
    private final zzeqd<zzdzk> zzftf;
    private final zzeqd<zzdqy> zzftq;
    private final zzeqd<zzcrw> zzftr;
    private final zzeqd<zzcvl> zzfts;

    public zzbmf(zzeqd<zzdqy> zzeqdVar, zzeqd<zzdzk> zzeqdVar2, zzeqd<zzcrw> zzeqdVar3, zzeqd<zzcvl> zzeqdVar4) {
        this.zzftq = zzeqdVar;
