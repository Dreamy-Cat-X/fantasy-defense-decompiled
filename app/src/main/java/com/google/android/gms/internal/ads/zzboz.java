...
public final class zzboz implements zzepq<zzbxf<zzbqv>> {
    private final zzeqd<Executor> zzeuj;
    private final zzeqd<zzcji> zzfwa;
    private final zzeqd<zzcom> zzfwb;

    private zzboz(zzeqd<zzcji> zzeqdVar, zzeqd<Executor> zzeqdVar2, zzeqd<zzcom> zzeqdVar3) {
        this.zzfwa = zzeqdVar;
        this.zzeuj = zzeqdVar2;
        this.zzfwb = zzeqdVar3;
    }

    public static zzboz zzh(zzeqd<zzcji> zzeqdVar, zzeqd<Executor> zzeqdVar2, zzeqd<zzcom> zzeqdVar3) {
        return new zzboz(zzeqdVar, zzeqdVar2, zzeqdVar3);
    }
