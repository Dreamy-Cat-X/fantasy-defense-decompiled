...
public final class zzho<T extends zzhq<T>> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x001c, code lost:
        ...
        if ((r3 instanceof com.google.android.gms.internal.measurement.zzih) == false) goto L4;
     */
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0025, code lost:
    
        if ((r3 instanceof com.google.android.gms.internal.measurement.zzia) == false) goto L4;
     */
    ...
    */
    ...
    public final void zza(zzho<T> zzhoVar) {
        ...
        Iterator<Map.Entry<T, Object>> it = zzhoVar.zza.zzd().iterator();
        while (it.hasNext()) {
            zzb(it.next());
        }
    }
