...
final /* synthetic */ class zzdcq implements Callable {
    static final Callable zzhah = new zzdcq();
    ...
    public final Object call() {
        ...
        if (((Boolean) zzwo.zzqq().zzd(zzabh.zzcmt)).booleanValue()) {
        ...
        bundle.putInt("web_view_count", com.google.android.gms.ads.internal.zzp.zzku().zzxp());
        return new zzdco(bundle);
    }
}
