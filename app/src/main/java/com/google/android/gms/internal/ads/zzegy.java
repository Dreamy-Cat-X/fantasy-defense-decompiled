...
public final class zzegy implements zzeaf {
    private static final ThreadLocal<Cipher> zzibr = new zzehb();
    private final SecretKey zzibs;

    public zzegy(byte[] bArr) throws GeneralSecurityException {
