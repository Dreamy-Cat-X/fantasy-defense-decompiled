...
public final class zzbji implements zzepq<Set<zzbxf<zzbrj>>> {
    private final zzeqd<zzbjf> zzeui;
    private final zzeqd<Executor> zzeuj;
    private final zzeqd<JSONObject> zzfrf;

    private zzbji(zzeqd<zzbjf> zzeqdVar, zzeqd<Executor> zzeqdVar2, zzeqd<JSONObject> zzeqdVar3) {
        this.zzeui = zzeqdVar;
        this.zzeuj = zzeqdVar2;
        this.zzfrf = zzeqdVar3;
    }

    public static zzbji zza(zzeqd<zzbjf> zzeqdVar, zzeqd<Executor> zzeqdVar2, zzeqd<JSONObject> zzeqdVar3) {
        return new zzbji(zzeqdVar, zzeqdVar2, zzeqdVar3);
    }
