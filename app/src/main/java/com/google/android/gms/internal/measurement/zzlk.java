...
interface zzlk {
    ...
    void zza(int i, zzgm zzgmVar) throws IOException;

    <K, V> void zza(int i, zzix<K, V> zzixVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzjv zzjvVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzjv zzjvVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzjv zzjvVar) throws IOException;

    void zzb(int i, List<zzgm> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzjv zzjvVar) throws IOException;
